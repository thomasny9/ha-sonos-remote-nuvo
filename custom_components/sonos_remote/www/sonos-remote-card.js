class SonosRemoteCard extends HTMLElement {
  ...
  _canSetVolume(entity) { return this._supports(entity,4); }
...
console.info("%c SONOS REMOTE WITH NUVO %c v0.5.3 ","color:white;background:#03a9f4;font-weight:bold","color:#03a9f4;background:white");
